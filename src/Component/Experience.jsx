...
const Experience = () => {
  ...
  const tabs = [
    ...
    { label: 'Petforde', content: 'As a Instructor, I mentoring student, and Provide documentation online platform. They focused on bug fixing, testing, and implementing new features using technologies like Chakra UI, React, TypeScript, and Golang. Their role emphasized delivering user-friendly, efficient solutions tailored to diverse customer needs.' },
    { label: 'Dateme.ai', content: 'As a Instructor, I mentoring student, and Provide documentation online platform. They focused on bug fixing, testing, and implementing new features using technologies like Chakra UI, React, TypeScript, and Golang. Their role emphasized delivering user-friendly, efficient solutions tailored to diverse customer needs.' },
  ...
  return (
    <div name="experience" className="w-fit h-fit sm:min-h-[900px] pb-[20px]  bg-[#090503] md:pl-[100px]  mx-auto pt-[75px]">
      ...
      {/* Tab Content */}
      <div className="mt-4 p-4 bg-[#23201f] rounded-lg mr-4 ml-4 space-y-10 ">
