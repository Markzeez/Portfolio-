...
const Experience = () => {
  ...
  return (
    <div name="experience" className="w-full h-[500px] bg-[#090503] md:pl-[100px] mx-auto pt-[75px]">
        <h1 className='text-4xl font-bold inline border-b-4 text-yellow-400 border-yellow-600 mt-10'>Experience</h1>
      {/* Tab Buttons */}
      ...
      {/* Tab Content */}
      <div className="mt-4 p-4 bg-[#23201f] rounded-lg mr-4 ">
